...
const routeName = computed(() =>
  props.isAdmin ? "AdminCoursePage" : "CoursePage"
);
</script>
...
<template>
  ...
  >
    ...
    <h2 class="text-sm font-bold">{{ props.courseTitle }}</h2>
  </RouterLink>
</template>

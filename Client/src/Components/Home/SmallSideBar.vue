...
<template>
  <div
    class="absolute left-0 top-0 z-50 h-screen cursor-pointer w-full max-w-[450px] items-center bg-blue-accent pt-8 duration-500 ease-linear md:hidden"
    ...
    <div :class="[`${isSideOpen ? `` : `hidden`}`]" class="mt-24 flex flex-col px-8">
      ...
      <div class="absolute bottom-0 mb-8 space-y-3">
        <div class="flex items-center gap-x-2 text-white">
          <svg class="size-5 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            <path

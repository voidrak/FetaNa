...
const selectedQuestionText = ref(null)
const selectedQuestionChoice_1 = ref(null)
const selectedQuestionChoice_2 = ref(null)
const selectedQuestionChoice_3 = ref(null)
const selectedQuestionChoice_4 = ref(null)
const selectedQuestionCorrect_Choice = ref(null)
...
function openEditQuestionModal(question) {
  ...
  selectedQuestionText.value = question.question_text
  selectedQuestionChoice_1.value = question.choice_1
  selectedQuestionChoice_2.value = question.choice_2
  selectedQuestionChoice_3.value = question.choice_3
  selectedQuestionChoice_4.value = question.choice_4
  selectedQuestionCorrect_Choice.value = question.correct_choice
  ...
  <AdminLayout>
    <div class="px-2 sm:py-4 md:py-8">
      ...
      <EditQuestionModal @closeEditQuestionModal="closeEditQuestionModal" :isEditQuestionOpen="isEditQuestionOpen"
        :question_id="selectedQuestionId" :questionText="selectedQuestionText" :choice_1="selectedQuestionChoice_1"
        :choice_2="selectedQuestionChoice_2" :choice_3="selectedQuestionChoice_3" :choice_4="selectedQuestionChoice_4"
        :correct_choice="selectedQuestionCorrect_Choice" @updateCourse="updateCourse" />
              ...
              <Disclosure v-slot="{ open }">
                ...
                <DisclosurePanel class="">
                  ...
                  <div class="w-full flex justify-end px-4 gap-x-4 my-4">
                    <svg @click="openEditQuestionModal(question)" class=" cursor-pointer size-6 fill-blue-accent"
                    ...
                    <svg @click="openDeleteQuestionModal(question.id)" class=" cursor-pointer size-6 fill-red-500"
